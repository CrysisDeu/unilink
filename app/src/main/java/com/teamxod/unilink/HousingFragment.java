...
public class HousingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        searchbar = layout.findViewById(R.id.editText1);
        //navibar = layout.findViewById(R.id.navigation);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent myIntent = new Intent(view.getContext(), SingleHousePostFragment.class);
